...
ALLOWED_HOSTS = ['*']
#ALLOWED_HOSTS = ['127.0.0.1','localhost','10.21.249.31','10.21.249.27']
...
INSTALLED_APPS = [
	'my_admin',
	'compressor',
    'projects_status.apps.Projects_statusConfig',
	'aplikasi.apps.AplikasiConfig',
...
#setting database yang pake mysql
DATABASES = {
        'default': {
...
SITE_HEADER = os.getenv('SITE_HEADER', 'Investment_Project_Management')

ADMINS = (
    (APP_NAME, APP_EMAIL)
)

#tambahan buat customize django admin
